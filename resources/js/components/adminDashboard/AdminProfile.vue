<template>
    ...
    <div class="flex flex-no-wraph h-[calc(100vh-80px)]">
        <div class="absolute flex-col justify-between hidden w-64 bg-gray-800 shadow sm:relative md:h-full sm:flex">
            <div class="px-8">
                <ul class="mt-12">
                    <li class="flex items-center justify-between w-full mb-6 text-gray-300 cursor-pointer">
                        <router-link to="/" class="ml-2 text-sm">
                                go to h
                        </router-link>
                        <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-600 rounded">5</div>
                    </li>
                    <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                            ...
                            <span class="ml-2 text-sm"><router-link to="/question-requestes">go to q</router-link></span>
                        </a>
                        <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-600 rounded">8</div>
                    </li>
                    <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                        ...
                        <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-600 rounded">25</div>
                    </li>
                    <li class="flex items-center justify-between w-full mb-6 text-gray-400 cursor-pointer hover:text-gray-300">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                    ...
                    <li class="flex items-center justify-between w-full text-gray-400 cursor-pointer hover:text-gray-300">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
                ...
                <div class="flex justify-center w-full mt-48 mb-4">
                    <div class="relative">
                        <div class="absolute inset-0 w-4 h-4 m-auto ml-4 text-gray-300">
        ...
        <div class="absolute z-40 flex-col justify-between w-64 transition duration-150 ease-in-out bg-gray-800 shadow md:h-full sm:hidden" id="mobile-nav">
            ...
            <div class="px-8">
                ...
                <ul class="mt-12">
                    <li class="flex items-center justify-between w-full mb-6 text-gray-300 cursor-pointer hover:text-gray-500">
                        <a href="javascript:void(0)" class="flex items-center focus:outline-none focus:ring-2 focus:ring-white">
...
<!-- 
    ...
    this may be used in manage page notifications
                        <div class="flex items-center justify-center px-3 py-1 text-xs text-gray-300 bg-gray-600 rounded">5</div>
