<x-molecules.home-section id="id">
    <div class="px-4 mx-auto sm:px-6 lg:px-8 max-w-7xl">
        <div class="max-w-2xl mx-auto text-center">
            <h1 class="heading heading-1">Contact Us</h1>
                ...
                <div class="px-6 py-12 sm:p-12">
                    ...
                    <form action="#" method="POST" class="mt-14">
                        <div class="grid gap-x-5 gap-y-4">
                            ...
                            <input class="input" type="text" placeholder="Enter your full name" aria-label="Full Name" />
                            <input class="input" type="password" placeholder="Enter your email" aria-label="Email" />
                            <input class="col-span-2 input" type="text" placeholder="Enter message title" aria-label="Title" />
                            ...
                            <button class="w-full btn btn-primary sm:col-span-2">
                                Send
                            </button>
                        </div>
                    </form>
